...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_num_list = 11,                  /* num_list  */
  YYSYMBOL_num = 12,                       /* num  */
  YYSYMBOL_delimiter_seq = 13              /* delimiter_seq  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "DELIMITER",
  "NEWLINE", "ERROR", "$accept", "program", "lines", "line", "num_list",
  "num", "delimiter_seq", YY_NULLPTR
};
...
{
      -4,     1,     8,     2,     9,     2,    11,    12,    15,    14,
       0,    10
};

static const yytype_int8 yycheck[] =
{
       0,     1,     5,     3,     0,     3,     5,     4,    13,     4,
      -1,     5
};
...
#line 1179 "y.tab.c"
  ...
  case 8: /* num_list: num delimiter_seq num_list  */
#line 77 "c4.y"
                               {
    (yyval.dval) = (yyvsp[-2].dval); // Здесь можно было бы складывать числа, если нужно
  }
#line 1187 "y.tab.c"
    break;
...
#line 83 "c4.y"
         {
    if ((int)(yyvsp[0].dval) == (yyvsp[0].dval)) {
      int_count++;
    } else {
      float_count++;
    }
...
#line 1200 "y.tab.c"
  ...
  case 10: /* delimiter_seq: DELIMITER  */
#line 94 "c4.y"
            {
    int used[7] = {0}; // Массив для отслеживания использованных разделителей
    used[(yyvsp[0].cval) - ','] = 1; // Отмечаем использованный разделитель
    switch ((yyvsp[0].cval)) {
...
#line 1217 "y.tab.c"
  ...
  case 11: /* delimiter_seq: DELIMITER DELIMITER  */
#line 106 "c4.y"
                      {
    int used[7] = {0};
    used[(yyvsp[-1].cval) - ','] = 1;
    ...
    if (used[(yyvsp[-1].cval) - ','] == 2 || used[(yyvsp[0].cval) - ','] == 2) {
